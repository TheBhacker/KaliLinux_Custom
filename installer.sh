...
function banner(){
    echo -e "\n${turquoiseColour}              _   _            ______"
    sleep 0.05
    echo -e " _ __   _ __ | |_| |__   ___  ___  /__  _  ___ __ _ _ __ ___   ___ _ __"
    sleep 0.05
    echo -e "| '_ \ | '_ \| __| '_ \ / _ \/ _ \ __| |/ __/ _\` | '_ \` _ \ / _ \ '__|"
    sleep 0.05
    echo -e "| |_) || | | | |_| | | |  __/  __/ /_| | (_| (_| | | | | | |  __/ |"
    sleep 0.05
    echo -e "| .__/ |_| |_|\__|_| |_|\___|\___|_(_) |\___\__,_|_| |_| |_|\___|_|  ${endColour}${yellowColour}(${endColour}${grayColour}By ${endColour}${purpleColour}N3tPhant0m${endColour}${yellowColour})${endColour}${turquoiseColour}"
    sleep 0.05
    echo -e "|_|                             |__/"
}
...
if [ "$user" == "root" ]; then
	...
	wal -nqi ~/Wallpapers/fondo.jpg
	sudo wal -nqi ~/Wallpapers/fondo.jpg
	echo -e "\n${greenColour}[+] Done\n${endColour}"
	sleep 1.5
    ...
    echo -e "\n${purpleColour}[*] Customizing neofetch configuration...\n${endColour}"
    sleep 2
    mkdir -p ~/.config/neofetch

    # Copia tu archivo preconfigurado
    cp $dir/neofetchcustom/config.conf ~/.config/neofetch/config.conf

    echo "Archivo de configuración de Neofetch reemplazado."
